    ...
    <div className="space-y-5">
      ...
      <div className="space-y-2.5">
        ...
        {priorities.map((item) => (
          ...
          >
            <button onClick={() => togglePriority(item.id)} className="flex-1 text-left">
              <span className={`text-base font-medium ${item.done ? 'text-[#666666] line-through' : 'text-white'}`}>
                {item.title}
              </span>
            </button>
            <div className="flex items-center gap-2">
              ...
              <button onClick={() => onMenu('priority', item.id)} className="p-2 text-[#666666]">
        ...
        {habits.map((habit) => (
          ...
          >
            <button onClick={() => toggleHabit(habit.id)} className="flex items-center gap-3 flex-1 text-left">
              ...
              <span className={`text-base font-medium ${habit.done ? 'text-[#666666] line-through' : 'text-white'}`}>
                {habit.title}
              </span>
            </button>
            <div className="flex items-center gap-2">
